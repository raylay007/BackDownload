...
public class TestDownloadAndZip : MonoBehaviour
{
        ...
        set
        {
            ...
            if (_isUnzip)
            {
                ...
                threadUnzip = new Thread(() => {
                    ...
                    StartOpenZip(zipFilePath, localSavePath);
    ...
    void StartOpenZip(string targetFilePath, string saveDir)
    {
        unzipProgress = 0;

        UnZip(targetFilePath, saveDir, () => {
